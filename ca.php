		...
		<!-- Header -->
			<div id="header">
				...
				<!-- Inner -->
					<div class="inner">
						<header>
							<h1><a href="index.php" id="logo">PTU CSE Syllabus Guide</a> &raquo;<a href="3rd-index.php"> 3rd Sem </a>&raquo; <a href="ca.php">CA</a></h1>
						</header>
					</div>
				...
				<div class="container">
					...
					<div class="row">
						<article class="4u special">
							<a href="ca-samplepaper.php" class="image featured"><img src="images/pic08.jpg" alt="" /></a>
