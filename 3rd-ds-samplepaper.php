		...
		<!-- Header -->
			<div id="header">
				...
				<!-- Inner -->
					<div class="inner">
						<header>
							<h1><a href="index.php" id="logo">..</a> &raquo; <a href="3rd-index.php">3rd Sem</a> &raquo; <a href="3rd-ds.php">DS</a> &raquo; <a href="3rd-ds-samplepaper.php">Sample Papers</a></h1>
						</header>
					</div>
					...
					<div class="row">
						<div class="12u skel-cell-mainContent" id="content">
							<article id="main" class="special">
								<header>
									<h2><a href="#">Discrete Structures &raquo; Sample Papers</a></h2>
									<span class="byline">
